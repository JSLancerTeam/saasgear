...
export async function loginFacebook(code: string) {
...
async function getAccessTokenFromFacebook(code: string): Promise<AxiosResponse<any>> {
...
async function getProfileUser(access_token: string): Promise<AxiosResponse<any>> {
