...
export default function EditTeam() {
  ...
  return currentTeam ? <>
    ...
    <div className="border-2 p-8 rounded shadow mt-4">
      ...
      <ListTeamMember teamMembers={currentTeam?.teamMembers.filter(it => it.status === 'active')} />
    </div>
    <InviteMember teamMembers={currentTeam?.teamMembers.filter(it => it.isActive === 'inactive')} />
  </> : null
}